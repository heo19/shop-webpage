            ...
            <Container className="subSection">
                <Row>
                    ...
                    <Col sm={4} className="subSectionOneText">
                        ...
                        <br />
                        <Link to="/detail"><Button variant="outline-dark" className="subSectionOneButton">Shop Now</Button></Link>
                    </Col>
                </Row>
            </Container>
            ...
            <Container className="subSection">
                <Row>
                    <Col sm={4} className="subSectionTwoText">
                        ...
                        <br />
                        <Link to="/detail"><Button variant="outline-dark">Shop Now</Button></Link>
                    </Col>
            ...
            <Container className="subSection">
                <Row>
                    ...
                    <Col sm={4} className="subSectionThreeText">
                        ...
                        <br />
                        <Link to="/detail"><Button variant="outline-dark" className="subSectionThreeButton">Shop Now</Button></Link>
                    </Col>
                </Row>
            </Container>
            <br />
